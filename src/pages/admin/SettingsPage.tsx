              ...
              <div className="space-y-6">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="text-amber-800 font-semibold uppercase tracking-wide">API INFORMATION</h3>
                      <p className="text-amber-700 text-sm mt-1">
                        If any data is missing, it's probably an API key mismatch. Contact your API provider for more information.
                      </p>
                    </div>
                  </div>
                </div>
